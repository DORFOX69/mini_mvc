<?php
// Cette vue affiche la liste des produits avec filtrage par catégorie
// Variables disponibles : $products, $categories, $selectedCategory, $searchTerm
?>
		...
		<div class="sidebar-section">
			...
			<form method="GET" action="/search" style="margin-bottom: 0;">
				<div class="form-group" style="margin-bottom: 0;">
					<input type="text" name="q" placeholder="Rechercher un produit..." required value="<?= htmlspecialchars($searchTerm ?? '') ?>">
				</div>
